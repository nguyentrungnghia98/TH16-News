            ...
            nyasa.window.on("load", function() {
                ...
                if (nyasa.scrollTop.length && !nyasa.isMobile) {
                    ...
                    nyasa.window.scroll(function() {
                            nyasa.window.scrollTop() > b && !a ? (nyasa.navbar.addClass(""), nyasa.scrollTop.addClass("in"), a = !0) : nyasa.window.scrollTop() < b && a && (nyasa.navbar.removeClass("shadow"), nyasa.scrollTop.removeClass("in"), a = !1)
                        }),
        ...
        var k = $('#mainnav-menu > li > a, #mainnav-menu-wrap .mainnav-widget a[data-toggle="menu-widget"]'),
            ...
            s = function() {
                ...
                a.length && a.each(function() {
                    ...
                    stop: !0 
                }), k.popover("dispose").unbind("mouseenter mouseleave"), o = !1
            },
            t = function() {
